...
// Logout
  ...
  Future<AuthResponse> refreshToken(BuildContext context) async {
    try {
      ...
      // Token'ın konsolda çıktısını görmek için ekliyoruz
      ...
      if (res.statusCode == 200) {
        ...
        // 500 hatası için özel yönetim
        showSnackBar(
            context, 'Sunucu hatası: Yenileme token geçersiz veya bulunamadı.');
        // Token geçersiz olduğu için oturumu kapatma işlemini tetikleyin
        // Bunu burada yapmak yerine, AuthBloc içinde yapabilirsiniz.
        return AuthResponse.failure(
